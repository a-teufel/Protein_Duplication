...
for(i in seq(1,2000,50)){
  ...
  name_WT<-paste("C:/Users/User/Documents/dup_alignments/M_SIM1_csv_files/M_SIM1_",i,".csv",sep="")  
  print(name_WT)
  ...
  name_EXP<-paste("C:/Users/User/Documents/dup_alignments/M_SIM2_csv_files/M_SIM2_",i,".csv",sep="")  
  ...
  if(length(which(chisquare_b$p.adjusted < 0.05)) == 0){
    ...
    timeB<-c(timeB, i)
    Gen<-makeB_sites(which(chisquare_b$p.adjusted < 0.05))
    sites_timeB<-append(sites_timeB,as.data.frame(Gen))
  }
...
write.csv(file="C:/Users/User/Documents/dup_alignments/diffs_A.csv", sites_timeA,row.names=FALSE)
write.csv(file="C:/Users/User/Documents/dup_alignments/diffs_B.csv", sites_timeB,row.names=FALSE)
write.csv(file="C:/Users/User/Documents/dup_alignments/diffs_C.csv", sites_timeC,row.names=FALSE)